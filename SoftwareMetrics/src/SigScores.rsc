...
public int ComplexityIndex(int Complexity) = ReturnScore(Complexity, [10,20,50]);
...
public int ComplexityScore(list[int] Distribution) = EvaluateDistribution(Distribution);
