...
// @ todo These values seem a bit off...
test bool SmallSqlSample() = ExpectEqual(7, GetClonedLinesDifference(SmallSqlSampleFile));
test bool SingleCloneSample() = ExpectEqual(6, GetClonedLinesDifference(SingleCloneFile));
test bool Type2NumericClones() = ExpectEqual(5, GetClonedLinesDifference(NumericSampleFile));
